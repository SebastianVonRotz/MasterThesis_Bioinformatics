...
export $(cat ./$1)
mkdir -p $DATAPATH_FILTER_TRIM_NANOFILT_D5_OUT

for fq in $DATAPATH_FILTER_TRIM_NANOFILT_D5_IN*.fastq
  do
    cat $fq | NanoFilt -q 7 -l 1000 --maxlength 2000  > $DATAPATH_FILTER_TRIM_NANOFILT_D5_OUT$(basename $fq)
  done
