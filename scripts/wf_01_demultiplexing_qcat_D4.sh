...
mkdir -p $DATAPATH_DEMULTPLEXING_QCAT_D4_OUT

cat $DATAPATH_DEMULTPLEXING_D4_IN/*.fastq | /cfs/earth/scratch/voro/python/bin/qcat -b $DATAPATH_DEMULTPLEXING_QCAT_D4_OUT
