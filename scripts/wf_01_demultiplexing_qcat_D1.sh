...
mkdir -p $DATAPATH_DEMULTPLEXING_QCAT_D1_OUT

cat $DATAPATH_DEMULTPLEXING_D1_IN/*.fastq | /cfs/earth/scratch/voro/python/bin/qcat -b $DATAPATH_DEMULTPLEXING_QCAT_D1_OUT
