...
mkdir -p $DATAPATH_DEMULTPLEXING_QCAT_D2_OUT

cat $DATAPATH_DEMULTPLEXING_D2_IN/*.fastq | /cfs/earth/scratch/voro/python/bin/qcat -b $DATAPATH_DEMULTPLEXING_QCAT_D2_OUT
