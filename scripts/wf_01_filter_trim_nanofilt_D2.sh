...
export $(cat ./$1)
mkdir -p $DATAPATH_FILTER_TRIM_NANOFILT_D2_OUT

for fq in $DATAPATH_FILTER_TRIM_NANOFILT_D2_IN*.fastq
  do
    cat $fq | NanoFilt -q 7 -l 1500 --maxlength 2500  > $DATAPATH_FILTER_TRIM_NANOFILT_D2_OUT$(basename $fq)
  done
